    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 gap-6">
        {periods.map((period) => {
          ...
          return (
            <div 
              key={period._id} // Usamos _id
              onClick={() => selectPeriod(period._id)} // Usamos _id
            ...
            >
              ...
              <div 
                ...
                style={{ backgroundColor: period.color || '#10B981' }} 
              ></div>
              ...
              <div className="flex justify-between items-start pl-4">
                ...
                <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button onClick={(e) => { e.stopPropagation(); deletePeriod(period._id); }} className="p-2 hover:bg-gray-100 dark:hover:bg-white/10 rounded-lg text-gray-400 hover:text-red-500">
                        <Trash2 size={18}/>
                    </button>
                </div>
              </div>
              ...
              <div className="mt-6 pl-4 grid grid-cols-2 gap-4">
                <div>
                    ...
                    {/* FIX: Agregado .toFixed(2) para evitar decimales largos */}
                    <span className="text-2xl font-black dark:text-white">${period.budget.toFixed(2)}</span>
                </div>
                <div className="text-right">
                    <span className="block text-xs text-gray-400 uppercase font-bold">Gastado Real</span>
                    {/* FIX: Agregado .toFixed(2) aquí también */}
