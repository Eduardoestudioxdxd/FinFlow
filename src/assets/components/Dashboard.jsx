...
  ];
  
  // Filtrar para Recharts: No renderizar si ambos valores son 0
...
                  >
                      {periods.map(p => (
                          <option key={p._id || generateId()} value={p._id}>{p.name}</option> 
                      ))}
                  </select>
...
                            </ResponsiveContainer>
                        ) : (
                             // Contenido de respaldo cuando no hay datos
                             <div className="absolute inset-0 flex items-center justify-center text-center text-gray-500 text-sm">Sin datos para gráfico</div>
                         )}
...
                            return (
                                <div key={tx._id || generateId()} className="flex items-center justify-between">
